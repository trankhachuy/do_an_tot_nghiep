                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{$post->post_title}}" class="form-control" onkeyup="ChangeToSlug();" id="slug" placeholder="Tên danh mục">
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" name="update-post" class="btn btn-info">Cập nhật bài viết</button>
                                </form>
                            </div>
